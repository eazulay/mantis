...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	if ( $f_additional_emails != "") {
		$f_additional_emails = email_append_domain( trim( $f_additional_emails ) );
		email_ensure_valid( $f_additional_emails );
		email_ensure_not_disposable( $f_additional_emails );
		if ( $f_additional_emails != user_get_field($t_user_id, 'additional_email_addresses') ) {
			user_set_field ( $t_user_id, 'additional_email_addresses', $f_additional_emails );
		}
	}
