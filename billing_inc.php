...
<?php
	...
	if ($f_get_bug_stats_button || $f_export_bug_stats_button){
		...
		if ($f_export_bug_stats_button){
			ob_start();
			echo "\"Period: {$t_bugnote_stats_from_d}/{$t_bugnote_stats_from_m}/{$t_bugnote_stats_from_y} - {$t_bugnote_stats_to_d}/{$t_bugnote_stats_to_m}/{$t_bugnote_stats_to_y}\"".
				$t_sep.$t_sep.$t_sep.'"'.gmdate( 'd/m/Y', time() ).'"'.$t_nl;
