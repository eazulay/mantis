...
$g_disallowed_files		= 'php,php3,phtml,html,class,java,exe,pl,erp';		# extensions comma separated
$g_allow_delete_own_attachments = ON;
$g_preview_max_height	= 350;
...
$g_resolution_enum_string = '10:open,20:fixed,25:query replied,30:reopened,40:unable to duplicate,50:not fixable,60:duplicate,70:not a bug,80:suspended,90:wont fix';
...
# --- Others ---
$g_default_home_page = 'view_all_bug_page.php';	# Set to name of page to go to after login
