...
function bugnote_get_all_bugnotes( $p_bug_id ) {
	...
	if( !isset( $g_cache_bugnotes[(int)$p_bug_id] ) ) {
		...
		$t_query = "SELECT b.*, t.note
						...
						ORDER BY b.date_submitted, b.id ASC';
		$t_bugnotes = array();
 ...
 * @param string $p_category Category Code ('0' for all)
 * @return array array of bugnote stats
 * @access public
 */
function bugnote_stats_get_project_array( $p_project_id, $p_from, $p_to, $p_cost, $p_category = '0') {
