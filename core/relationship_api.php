...
function relationship_get_all_src( $p_src_bug_id ) {
	...
	$query = "SELECT $t_mantis_bug_relationship_table.id, $t_mantis_bug_relationship_table.relationship_type,
				...
				ORDER BY relationship_type, $t_mantis_bug_relationship_table.destination_bug_id";
...
function relationship_get_all_dest( $p_dest_bug_id ) {
	...
	$query = "SELECT $t_mantis_bug_relationship_table.id, $t_mantis_bug_relationship_table.relationship_type,
				...
				ORDER BY relationship_type, $t_mantis_bug_relationship_table.source_bug_id";
...
/**
 * Sort function - compare two relationships by type and descending id
 */
function cmp_relationships( $a, $b ) {
	$common_bug = ( $a->src_bug_id == $b->dest_bug_id ) ? $a->src_bug_id : $b->src_bug_id;
	$a_bug = ($a->src_bug_id == $common_bug) ? $a->dest_bug_id : $a->src_bug_id;
	$b_bug = ($b->src_bug_id == $common_bug) ? $b->dest_bug_id : $b->src_bug_id;
...
<?php collapse_open('relationships', '', 'closed');?>
