...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category" width="30%">
		<?php echo lang_get( 'additional_emails' ) ?>
	</td>
	<td width="70%">
		<input type="text" size="90" maxlength="250" name="additional_emails" value="<?php echo string_attribute( $t_user['additional_email_addresses'] ) ?>" />
	</td>
</tr>
