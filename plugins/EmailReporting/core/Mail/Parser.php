...
class ERP_Mail_Parser
{
	...
	private $_from;
	private $_subject;
	private $_def_charset = 'UTF-8, Windows-1252, auto'; // 'UTF-8, ISO-8859-1, auto'
	...
	* http://lists.w3.org/Archives/Public/ietf-charsets/2001AprJun/0030.html */
	...
	private function setBody( $body, $ctype_primary, $ctype_secondary, $charset )
	{
		...
		if ( 'text' === $this->_ctype['primary'] &&	'plain' === $this->_ctype['secondary'] )
		{
			...
			$body = str_replace("--\r\nEyal Azulay   MBCS CITP\r\nSoftware Engineer and Web Developer\r\n______________________________________________________\r\n\r\n+353 1 254 2226           Skype: azulayeyal\r\n+353 85 255 9225       http://get-it-write.com/  http://get-it-write.com", "", $body);
			...
			$body = str_replace(" RealCorp Luxembourg, 31 Bd Prince Henri L-1724\r\n\r\n  https://realcorp.lu/blog  \r\n  https://realcorp.lu/  \r\n  https://goo.gl/maps/1zhT8zPKDGv  \r\n  https://www.linkedin.com/company/realcorpluxembourg  \r\n  https://twitter.com/RealCorp_LU  \r\n\r\n  https://realcorp.lu/property/property-search/   https://realcorp.lu/property/my-property-requirements/", "", $body);
		...
		if ( 'text' === strtolower( $parts[ $i ]->ctype_primary ) && in_array( strtolower( $parts[ $i ]->ctype_secondary ), array( 'plain', 'html' ), TRUE ) )
		{
			...
			else
			{
				...
				if ( $t_body_charset == 'iso-8859-1' ) {
					...
					echo "\nChanged body charset from iso-8859-1 to $t_body_charset\n";
				}
