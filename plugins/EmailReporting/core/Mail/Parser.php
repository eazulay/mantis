	...
	* http://lists.w3.org/Archives/Public/ietf-charsets/2001AprJun/0030.html */
	...
	private function setBody( $body, $ctype_primary, $ctype_secondary, $charset )
	{
		...
		if ( 'text' === $this->_ctype['primary'] &&	'plain' === $this->_ctype['secondary'] )
		{
			...
			// Strip signatures
			$body = str_replace("-- \r\n\r\n\r\nEyal Azulay MBCS CITP\r\nSoftware Developer & System Administrator\r\nT. +44 20 3290 9094\r\nM. +33 6 76 83 98 56\r\n\r\n <https://realcorp.lu/> \r\n\r\nFind us:  <https://goo.gl/maps/1zhT8zPKDGv> 31 Blvd Prince Henri L-1724\r\nLuxembourg\r\nFind a property:  <https://realcorp.lu/property/property-search/> Perform\r\nyour own search\r\nLet us help you:   <https://realcorp.lu/property/my-property-requirements/>\r\nAsk us to search for you\r\n\r\n <https://twitter.com/RealCorp_LU>\r\n<http://www.linkedin.com/company/realcorp-luxembourg?trk=top_nav_home>\r\n<https://pinterest.com/realcorplu/boards/>     <https://realcorp.lu/blog/> \r\n", "", $body);
			...
			$body = str_replace("\r\n  http://realcorp.lu/  \r\nFollow us:     https://twitter.com/RealCorp_LU   http://www.linkedin.com/company/realcorp-luxembourg?trk=top_nav_home   https://plus.google.com/u/0/107971306862269182751/posts   http://pinterest.com/realcorplu/boards/   Find us: 31 Blvd Prince Henri L-1724 Luxembourg\r\n", "", $body);
			$body = preg_replace("/(\r\n\r\n  https?\:\/\/realcorp\.lu\/about\/management\-team\/[^\r\n]*)/", '', $body);
			$body = str_replace("-- \r\n\r\nThis e-mail and any files transmitted with it are confidential and are  intended solely for the use of the individual or entity to whom it is  addressed. If you are not the intended recipient and you have received this  e-mail in error, then any use, dissemination, forwarding, printing or  copying of this e-mail is strictly prohibited and you should contact the  sender by e-mail return and then delete all the material from your system.  Our company accepts no liability for the content of this email, or for the  consequences of any actions taken on the basis of the information provided,  unless that information is subsequently confirmed in a letter written on  RealCorp Letterhead and signed by an authorised signatory. Any views or  opinions presented are solely those of the author and do not necessarily  represent those of Realcorp Luxembourg SA. This e-mail does not form part  of a legally binding agreement. We have taken precautions to minimize the  risk of transmitting software viruses, but we advise that you carry out  your own checks on any attachments to this message. We cannot accept  liability for any loss or damage caused by software viruses.\r\n", "", $body);
			$this->_body = $body;
		}
