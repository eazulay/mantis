...
class simple_html_dom
{
    ...
    function load($str, $lowercase=true, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
    {
		...
		// Eyal: Replace single line breaks with double
		$this->doc = str_replace("<br> ", "<br>", $this->doc); // but first make sure consequtive <br>s are not separated by a space
		$this->doc = str_replace("</p> ", "</p>", $this->doc); // and remove single spaces between paragraphs
		$this->doc = preg_replace("/(?<!<br>)<br>(?!<br>)/i", "<br><br>", $this->doc);
    ...
    protected function prepare($str, $lowercase=true, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
    {
		...
		// Eyal: Add <br>s inside <pre> tags
		$parts = preg_split("/(<pre.*>|<\/pre>)/Usu",$str,-1,PREG_SPLIT_DELIM_CAPTURE);
		...
		$str = implode('',$parts);
		// Eyal
		$str = preg_replace("/^\h+/m", "", $str); // Trim spaces at beginning of lines
		$str = str_replace("<tr>=20\r\n", "<tr>", $str); // Prevent new lines after table row start
		$str = str_replace("</th>=20\r\n", "</th> ", $str); // Prevent new lines after table header end
		$str = str_replace("</th>\r\n", "</th>", $str);
		$str = str_replace("=20\r\n", "\r\n", $str); // Strip =20 from end of lines
		$str = str_replace("=\r\n", "", $str); // Unsplit lines
		$str = str_replace("</p>", "<br></p>", $str); // Add <br>s before </p> tags
