...
<div class="border center">
	<form method="post" action="<?php print plugin_page('manage_proj_cat_delete.php', true);?>">
		...
		<input type="hidden" name="project_id" value="<?php echo string_attribute( $t_project_id ) ?>" />
