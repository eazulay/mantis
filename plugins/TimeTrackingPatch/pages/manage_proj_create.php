...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	$f_user_price	= gpc_get_int( 'user_price' );
	...
	$t_project_id = project_create( strip_tags( $f_name ), $f_description, $f_status, $f_view_state, $f_file_path, true, $f_inherit_global, $f_user_price );
	...
	$t_redirect_url = plugin_page('manage_proj_page.php', true);
