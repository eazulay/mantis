...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	if ( true == $f_add_and_edit ) {
		$t_redirect_url = plugin_page('manage_proj_ver_edit_page.php&version_id='.$t_version_id, true);
	} else {
		$t_redirect_url = plugin_page('manage_proj_edit_page.php&project_id='  .$f_project_id, true);
	}
