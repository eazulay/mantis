...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	$t_cookie = user_create( $f_username, $f_password, $f_email, $f_access_level, $f_protected, $f_enabled, $t_realname, $t_admin_name, $f_default_price );
	...
	if ( $t_cookie === false ) {
		$t_redirect_url = 'plugin.php?page='.plugin_get_current().'/manage_user_page.php';
	} else {
		# ok, we created the user, get the row again
		$t_user_id = user_get_id_by_name( $f_username );
		$t_redirect_url = 'plugin.php?page='.plugin_get_current().'/manage_user_edit_page.php&user_id=' . $t_user_id;
	}
