...
<!-- USER INFO -->
<div align="center">
<form method="post" action="<?php print plugin_page('manage_user_update.php', true)?>">
...
<!-- Default price per project -->
<tr <?php echo helper_alternate_class() ?>>
	<td class="category">
		<?php echo plugin_lang_get( 'default_price_lbl' ) ?>:
	</td>
	<td>
		<input type="text" name="default_price" value="<?php print user_get_field($t_user['id'], 'default_price' ); ?>" />
	</td>
</tr>
...
<!-- Reset Button -->
	<form method="post" action="<?php print plugin_page('manage_user_reset.php', true);?>">
...
<?php if ( !( ( user_is_administrator( $t_user_id ) && ( user_count_level( config_get_global( 'admin_site_threshold' ) ) <= 1 ) ) ) ) { ?>
	<form method="post" action="<?php print plugin_page('manage_user_delete.php', true);?>">
...
<form method="post" action="<?php print plugin_page('manage_user_proj_add.php', true);?>">
...
<?php
	...
	edit_account_prefs( $t_user['id'], false, false, plugin_page('manage_user_edit_page.php&user_id=' . $t_user_id, true) );
