...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	$f_default_price= gpc_get_string( 'default_price' );
	...
	$c_default_price= db_prepare_string( $f_default_price );
	...
	if ( $f_protected && $t_old_protected ) {
	    $query = "UPDATE $t_user_table
	    		SET username=" . db_param() . ", email=" . db_param() . ",
	    			protected=" . db_param() . ", realname=" . db_param() . ", default_price=" . db_param() . "
	    		WHERE id=" . db_param();
	    $query_params = Array( $c_username, $c_email, $c_protected, $c_realname, $c_default_price, $c_user_id );
	} else {
	    $query = "UPDATE $t_user_table
	    		SET username=" . db_param() . ", email=" . db_param() . ",
	    			...
	    			protected=" . db_param() . ", realname=" . db_param() . ", default_price=" . db_param() . "
	    		WHERE id=" . db_param();
	    $query_params = Array( $c_username, $c_email, $c_access_level, $c_enabled, $c_protected, $c_realname, $c_default_price, $c_user_id );
	}
    ...
    $t_redirect_url = plugin_page('manage_user_edit_page.php', true)."&user_id=" . $c_user_id;
